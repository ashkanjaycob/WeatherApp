<template>
  <div>
    ...
    <div class="row  d-flex justify-content-center  ">
      <!-- <div class="card bgr col-md-3 col-lg-6 d-none d-md-block m-2">
      ...
      <div class="card  m-2 col-10 col-md-8 col-lg-5 ">
        <div class="maino">
          ...
          <div icon="cloudy d-none" data-label="Perfect">
            <span class="cloud"></span>
            <span class="cloud"></span>
          </div>

          <div icon="snowy d-none" data-label="Chilly">
          ...
          <div icon="stormy d-none" data-label="Soggy">
            <span class="cloud"></span>
            <ul>
              <li></li>
              <li></li>
          ...
          <div icon="supermoon d-none" data-label="Cool!">
            <span class="moon"></span>
            <span class="meteor"></span>
          </div>
        </div>
        <h1 class="card-title d-inline" style="font-size: 5.8rem;">{{ data.main.temp }}<i
            class="bi bi-thermometer-half fs-1"></i>
             <span class="d-flex justify-content-end  position-relative"><img
              class="position-absolute fixicon bottom-100 rounded-circle bg-dark " :src="show" alt=""></span>
        </h1>
        <div class="card-body">
          <i class="bi bi-geo-alt-fill fs-4 px-2"></i>
          <h1 class="card-title d-inline">{{ data.name }}</h1>
          <hr>

          <h3 class="card-title d-inline">{{ data.weather[0].main }}</h3>

          <h4 class="py-2"><i class="bi bi-border-width fs-6"></i> {{ data.weather[0].description }}</h4>
          <hr>
          <ul class="list-group list-group-flush">
            <li class="list-group-item">
              <h4><i class="bi bi-person-dash-fill "></i> Temp</h4>humidity:{{ data.main.humidity }} / Feels:
              {{ data.main.feels_like }}
            </li>
            <li class="list-group-item">
              <h4><i class="bi bi-wind "></i> Wind </h4>Deg:{{ data.wind.deg }} / Speed:{{ data.wind.speed }}
            </li>
            <li class="list-group-item">
              <h4> <i class="bi bi-globe"></i> Country</h4>Name: {{ data.sys.country }} / TimeZone:
              {{ data.timezone }} / <img :src="flag">
...
<style>
.bgr {
  background: url(../assets/Rain1.jpg);
}
...
[icon] {
  ...
  height: 1em;
  margin: .3em;
  box-shadow: 0 0 0 0 var(--ring) inset, 0 0 .3em -.03em var(--shadow);
